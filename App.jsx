...
const Modal=({title,onClose,children,wide=false})=> createPortal(
  <div style={{position:"fixed",inset:0,background:"#000000DD",zIndex:2000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={e=>e.target===e.currentTarget&&onClose()}>
